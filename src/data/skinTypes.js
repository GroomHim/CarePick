...
export const skinTypes = {
  ...
  "건성 1번": {
    id: 1,
    name: "건성 1번",
    description: "건성, 예민, 착색도 높은 1번 타입 피부는 수분 부족으로 인해 건조함을 자주 느끼며, 외부 자극에 민감하게 반응할 수 있는 유형입니다. 또한 착색도가 높아 색소침착이 쉽게 발생할 수 있습니다. 이러한 피부는 수분 공급과 진정 케어에 특히 집중해야 하며, 촉촉함을 유지할 수 있는 고보습 제품을 사용하는 것이 중요합니다. 나이아신아마이드를 사용하면 색소침착 완화에 도움이 됩니다. 자극이 적은 약산성 제품을 선택하고, 레티놀은 저농도부터 시작해야 합니다. 외출 시에는 자외선 차단제를 필수적으로 사용해 추가적인 착색을 방지해야 합니다. 또한, 나이트 크림이나 수면 팩으로 밤 사이 피부 장벽을 강화하는 것도 좋은 방법입니다.",
    products: [
      {
        type: "앰플",
  ...
  "건성 2번": {
    id: 2,
    name: "건성 2번",
    description: "건성, 착색도 높은 2번 피부는 건조함과 색소침착이 고민이 될 수 있는 피부 유형입니다. 피부 장벽 강화가 중요하며, 나이아신아마이드를 사용하면 색소침착 완화에 도움이 됩니다. 자극이 적은 약산성 세안제와 고보습 크림 사용이 좋습니다. 또한, 자외선 차단제로 색소침착 예방이 필요합니다. 특히, 영양이 풍부한 수면 팩으로 피부를 관리하면 좋습니다. 피부 턴오버 주기에 맞춰 자신에게 적합한 화장품을 찾아 꾸준히 사용하는 것이 중요합니다.",
    products: [
      {
        type: "세럼",
  ...
  "건성 3번": {
    id: 3,
    name: "건성 3번",
    description: "건성, 예민, 착색도 낮은 3번 피부는 건조하고 예민하지만, 착색도는 낮은 편입니다. 약산성 제품과 보습제를 사용하는 것이 중요합니다. 레티놀은 낮은 농도부터 천천히 사용해야 합니다. 물리적 각질 제거는 피하고 수분 공급에 집중하는 것이 좋습니다. 피부 장벽을 강화할 수 있는 진정 효과가 있는 제품을 선택하는 것이 중요합니다. 자외선 차단제는 필수적으로 사용하여 피부 손상을 예방해야 합니다.",
    products: [
      {
        type: "수분크림",
  ...
  "건성 4번": {
    id: 4,
    name: "건성 4번",
    description: "건성, 착색도 낮은 4번 타입 피부는 건조하지만 착색도가 낮아 비교적 깨끗한 피부 톤을 유지하고 있는 것이 특징입니다. 나이아신아마이드, 판테놀 등의 성분이 도움됩니다. 자외선 차단으로 피부 손상을 방지하고, 고보습 크림과 세럼으로 관리하면 좋습니다. 피부 턴오버 주기에 맞춰 자신에게 적합한 화장품을 사용하는 것이 중요합니다. 특히 수분 공급과 자외선 차단을 철저히 하여 피부 손상을 예방하는 것이 좋습니다.",
    products: [
      {
        type: "수분크림",
  ...
  "중성 1번": {
    id: 5,
    name: "중성 1번",
    description: "중성, 예민, 착색도 높은 5번 타입 피부는 유분과 수분의 균형이 잘 맞아 있기 때문에, 이러한 밸런스를 유지하는 것이 중요합니다. 그러나 피부가 민감해 사용하는 제품에 따라 피부 상태가 크게 달라질 수 있으므로, 화장품 선택에 신중해야 합니다. 만약 맞지 않는 화장품 사용으로 인해 피부에 일시적인 반응이 나타나기 쉬운 유형이며, 이때 적절한 미백 및 관리가 이루어지지 않으면 흔적이 남을 수 있으므로, 초기부터 진정 효과가 있는 화장품을 사용하는 것이 중요합니다. 민감성 피부에 적합한 제품과 나이아신아마이드 성분이 포함된 착색 개선 화장품을 사용하는 것이 좋습니다. 또한, 레티놀 성분은 미백과 피부결 개선에 도움이 될 수 있지만, 예민한 피부에는 주의가 필요합니다.",
    products: [
      {
        type: "토너",
  ...
  "중성 2번": {
    id: 6,
    name: "중성 2번",
    description: "중성, 착색도 높은 6번 타입 피부는 유분과 수분의 균형이 잘 맞는 중성 타입이지만, 착색도가 높아 색소침착이 고민이 될 수 있는 피부 유형입니다. 이러한 피부는 밸런스를 유지하면서도 착색 관리에 중점을 둔 화장품 선택이 중요합니다. 레티놀이나 나이아신아마이드 성분이 포함된 기능성 화장품을 사용하면 미백 및 피부결 개선에 도움이 되며, 피부 개선 효과를 크게 느낄 수 있습니다. 또한, 피부 턴오버 주기에 맞춰 자신에게 적합한 화장품을 찾아 꾸준히 사용하는 것이 필요합니다. 외출 시에는 자외선 차단제를 철저히 발라 색소침착이 더 심해지지 않도록 주의하는 것도 중요합니다.",
    products: [
      {
        type: "토너",
  ...
  "중성 3번": {
    id: 7,
    name: "중성 3번",
    description: "중성, 예민, 착색도 낮은 7번 타입 피부는 유분과 수분의 균형이 잘 맞아 있어 이러한 밸런스를 유지하는 것이 중요합니다. 그러나 피부가 민감해 사용하는 제품에 따라 피부 상태가 크게 달라질 수 있으므로, 화장품 선택에 신중해야 합니다. 특히 맞지 않는 화장품을 사용했을 때 피부에 일시적인 반응이 나타날 수 있으며, 적절한 미백 및 관리가 이루어지지 않으면 흔적이 남을 수 있습니다. 따라서 초기부터 진정 효과가 있는 화장품을 사용해 피부를 보호하는 것이 중요합니다. 민감성 피부에 적합한 제품을 사용하는 꾸준한 관리가 필요합니다.",
    products: [
      {
        type: "토너",
  ...
  "중성 4번": {
    id: 8,
    name: "중성 4번",
    description: "중성, 착색도 낮은 8번 타입 피부는 유분과 수분의 균형이 잘 맞는 중성 타입으로, 착색도가 낮아 비교적 깨끗한 피부 톤을 유지하고 있는 것이 특징입니다. 그러나 이러한 밸런스를 유지하기 위해서는 피부 관리에 소홀하지 않아야 합니다. 피부 턴오버 주기에 맞춰 자신에게 적합한 화장품을 사용하는 것이 중요합니다. 특히 수분 공급과 자외선 차단을 철저히 하여 피부 손상을 예방하는 것이 좋습니다. 또한, 피부 상태를 주기적으로 점검하여 필요한 경우 미백이나 진정 케어 제품을 보완해 사용하면 더욱 안정적인 피부 컨디션을 유지할 수 있습니다.",
    products: [
      {
        type: "토너",
        name: "바이오더마 하이드라비오 토너 500ml",
  ...
  "지성 1번": {
    id: 9,
    name: "지성 1번",
    description: "지성, 예민, 착색도 높은 1번 타입의 피부는 피지 분비량이 많아 유분기로 인한 고민이 생기기 쉬운 피부 유형입니다. 여드름 상처나 뾰루지 자국이 남아 착색 관리가 필요하며, 민감성 피부에 적합한 제품과 나이아신아마이드 성분이 도움됩니다. 레티놀은 저농도부터 시작해야 하며, 자외선 차단제로 색소침착을 예방해야 합니다. 피부 턴오버 주기에 맞춰 자신에게 적합한 화장품을 찾아 꾸준히 사용하는 것이 중요합니다.",
    products: [
      {
        type: "토너",
        name: "반코르 포어 타이트닝 토너",
  ...
  "지성 2번": {
    id: 10,
    name: "지성 2번",
    description: "지성, 착색도 높은 2번 타입의 피부는 피지 분비량이 많아 유분기로 인한 고민이 생기기 쉬운 피부 유형입니다. 피지 때문에 모공이 막혀 여드름이나 일시적인 뾰루지가 발생하기 쉬워 초기 관리가 중요합니다. 꾸준한 세안과 여드름 케어만으로도 개선 효과를 볼 수 있습니다. 여드름이 생긴 후 적절한 미백 및 관리가 이루어지지 않으면 흔적이 영구적으로 남을 수 있으므로, 비위생적으로 여드름을 짜지 않고 초기부터 패치나 진정용 화장품을 사용하는 것이 중요합니다. 예방 뿐만 아니라 사후 관리에도 주의를 기울여야 합니다. 2번 타입의 경우 세안과 여드름 관리만 잘해도 피부 개선 효과를 확실히 느낄 수 있습니다.",
    products: [
      {
        type: "토너",
        name: "유세린 토너",
  ...
  "지성 3번": {
    id: 11,
    name: "지성 3번",
    description: "지성, 예민, 착색도 낮은 3번 타입 피부는 피지 분비량이 많아 유분기로 고민이 생기기 쉬운 유형입니다. 또한 피부가 민감해 사용하는 제품에 따라 피부 상태가 크게 달라질 수 있으므로, 화장품 선택에 신중해야 합니다. 지용성과 민감성을 동시에 고려한 전용 화장품을 사용하는 것이 추천됩니다. 레티놀 성분은 미백 및 피부결 개선에 효과적일 수 있지만, 예민한 피부에는 주의가 필요합니다. 세안 시 피부가 지나치게 건조해지지 않도록 미온수로 세안한 후 즉시 수분을 보충해 주는 것이 중요합니다.",
    products: [
      {
        type: "토너",
        name: "에뛰드 약산성 토너",
  ...
  "지성 4번": {
    id: 12,
    name: "지성 4번",
    description: "지성, 착색도 낮은 4번 타입 피부는 피지 분비량이 많아 유분기로 인한 고민이 생기기 쉬운 유형입니다. 저자극 세안제를 사용하고, 레티놀이나 나이아신아마이드 성분이 포함된 기능성 화장품을 사용하면 피부 개선에 도움이 됩니다. 자외선 차단제로 피부 손상을 방지하고, 피부 턴오버 주기에 맞춰 자신에게 적합한 화장품을 사용하는 것이 중요합니다. 특히 모공 관리와 수분 공급을 철저히 하여 피부 손상을 예방하는 것이 좋습니다.",
    products: [
      {
        type: "클렌징 폼",
        name: "어퓨 딥 클린 폼렌저",
